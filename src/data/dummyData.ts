...
export const dummyVideos: Video[] = [
  ...
  {
    id: 'v7',
    title: 'We Compared Every Flagship Camera in 2026',
    channel: channelById('c2'),
    durationLabel: '18:24',
    viewsLabel: '1.5M',
  ...
  {
    id: 'v9',
    title: 'Building a Video App from Scratch',
    channel: channelById('c4'),
    durationLabel: '22:47',
    viewsLabel: '31K',
  ...
  {
    id: 'v11',
    title: 'Why the Universe Is Flat (Probably)',
    channel: channelById('c1'),
    durationLabel: '11:33',
    viewsLabel: '4.7M',
  ...
  {
    id: 'v12',
    title: 'A Week With the Newest Foldable Phone',
    channel: channelById('c2'),
    durationLabel: '13:12',
    viewsLabel: '710K',
  ...
  {
    id: 'v13',
    title: 'The Engineering Behind Suspension Bridges',
    channel: channelById('c3'),
    durationLabel: '19:41',
    viewsLabel: '1.8M',
  ...
  {
    id: 'v14',
    title: 'Debugging a Native Module in One Evening',
    channel: channelById('c4'),
    durationLabel: '15:20',
    viewsLabel: '18K',
    publishedLabel: '12 hours ago',
    thumbnailColor: '#FFD93D',
    commentsEnabled: true,
  },
  {
    id: 'v15',
    title: 'Can an AI Write a Better Screenplay Than a Human?',
    channel: channelById('c5'),
    durationLabel: '7:15',
    viewsLabel: '1.1M',
    publishedLabel: '9 hours ago',
    thumbnailColor: '#C77DFF',
    commentsEnabled: true,
  },
  {
